...
async def seed_in_memory_db(db):
    ...
    # Seed CR and LR dummy accounts for each section (II-CSE-A to II-CSE-J)
    sections = ["II-CSE-A", "II-CSE-B", "II-CSE-C", "II-CSE-D", "II-CSE-E", "II-CSE-F", "II-CSE-G", "II-CSE-H", "II-CSE-I", "II-CSE-J"]
