  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground font-mono bg-muted/50 p-2 rounded text-left break-words overflow-auto max-h-32 text-xs">
  ...
  head: () => ({
    meta: [
      ...
      { title: "Faculty Attendance & Session Monitoring System" },
      {
        name: "description",
        content:
          "College system for monitoring faculty attendance across scheduled class sessions.",
      },
