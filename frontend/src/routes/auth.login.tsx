...
export const Route = createFileRoute("/auth/login")({
  head: () => ({
    meta: [
      { title: "CR / LR Login — Faculty Attendance Monitor" },
      { name: "description", content: "Class and Lateral Representative sign-in to report faculty attendance for class sessions." },
      { property: "og:title", content: "CR / LR Login — Faculty Attendance Monitor" },
      { property: "og:description", content: "Sign in to report faculty attendance for your section's sessions." },
    ],
  }),
  component: CRLRLoginPage,
});

function CRLRLoginPage() {
      ...
      <Card className="w-full max-w-md">
        <CardHeader className="items-center text-center">
          ...
          <CardDescription className="flex items-center justify-center gap-1.5 font-medium text-foreground">
            <Users className="size-4" /> CR / LR Login
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form className="space-y-4" onSubmit={handleSubmit} noValidate>
            ...
            <div className="space-y-1.5">
              <Label htmlFor="crlr-password">Password</Label>
